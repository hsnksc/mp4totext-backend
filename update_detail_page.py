"""
Update TranscriptionDetailPage to show enhanced text and summary
"""
...
NEW_DETAIL_PAGE = '''import React, { useEffect, useState } from 'react';
...
def main():
    print("\n🚀 Updating TranscriptionDetailPage...")
    print("=" * 50)
    
    try:
        print(f"📝 Writing to {DETAIL_PAGE}...")
        DETAIL_PAGE.write_text(NEW_DETAIL_PAGE, encoding='utf-8')
        print("✅ TranscriptionDetailPage.tsx updated successfully!")
        print("\n📋 New features:")
        print("   • Tabs: Original / Enhanced / Summary")
        print("   • Show Whisper model used")
        print("   • Display Gemini improvements")
        print("   • Speaker segments with colors")
