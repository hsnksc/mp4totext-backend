#!/usr/bin/env python3
"""
LoginPage.tsx - navigate yerine window.location
"""
import os
...
print("🔧 LoginPage.tsx güncelleniyor...\n")

login_path = os.path.join(WEB_SRC, "pages", "LoginPage.tsx")
with open(login_path, "w", encoding="utf-8") as f:
    f.write(LOGIN_PAGE)

print("✅ pages/LoginPage.tsx güncellendi!")
print("\n📍 Değişiklikler:")
print("   • navigate() yerine window.location.href kullanılıyor")
print("   • Force page reload ile redirect")
