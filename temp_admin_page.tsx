...
const AdminDashboardPage = () => {
  ...
  const handleSavePricing = async () => {
    ...
    try {
      ...
      if (typeof detail === 'object' && 'message' in detail) {
        ...
        setError(typeof detail === 'string' ? detail : 'GÃ¼ncelleme baÅŸarÄ±sÄ±z');
      }
    } finally {
      setSaving(false);
    }
  ...
  const pricingFields = [
    ...
    { key: 'speaker_recognition', label: 'Konuşmacı± TanÄ±ma (ek)', unit: 'kredi/dk' },
    { key: 'youtube_download', label: 'YouTube Ä°ndirme', unit: 'kredi' },
    ...
    { key: 'exam_questions', label: 'SÄ±nav SorularÄ±', unit: 'kredi' },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex gap-4 mb-8">
          ...
          >
            ...
            {i18n.language === 'tr' ? 'FiyatlandÄ±rma' : 'Pricing'}
          </button>
          <button
          ...
          >
            ...
            {i18n.language === 'tr' ? 'KullanÄ±cÄ±lar' : 'Users'}
          </button>
          <button
            ...
            <div className="p-6 border-b border-slate-700 flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold text-white">
                  {i18n.language === 'tr' ? 'Kredi FiyatlandÄ±rmasÄ±' : 'Credit Pricing'}
                </h2>
                <p className="text-slate-400 text-sm mt-1">
                  {i18n.language === 'tr' ? 'Ä°ÅŸlem başı±na kredi maliyetlerini yÃ¶netin' : 'Manage credit costs per operation'}
                </p>
              </div>
              {!editingPricing ? (
                <button
                ...
                >
                  ...
                  {i18n.language === 'tr' ? 'DÃ¼zenle' : 'Edit'}
                </button>
              ) : (
        ...
        {activeTab === 'models' && !loading && (
          <div className="glass-effect rounded-2xl overflow-hidden fade-in">
            <div className="p-6 border-b border-slate-700 flex justify-between items-center">
              <div>
                <h2 className="text-2xl font-bold text-white">AI Model FiyatlandÄ±rmasÄ±</h2>
                <p className="text-slate-400 text-sm mt-1">
                  Her AI modeli iÃ§in kredi Ã§arpanlarÄ±nÄ± yÃ¶netin
                </p>
              </div>
              {!editingModels ? (
                <button
            ...
            <div className="p-6 space-y-4">
              {editedModels.map((model, index) => (
                <div key={model.id} className="p-4 bg-white/5 rounded-xl space-y-3">
                        ...
                        <>
                          ...
                          <label className="flex items-center gap-2 text-sm">
                            <input
                              ...
                              className="w-4 h-4 rounded"
                            />
                            <span className="text-slate-400">VarsayÄ±lan</span>
                          </label>
                        </>
                      ) : (
                        <div className="flex gap-2">
                  ...
                  {editingModels && (
                    <div>
                      <label className="text-slate-400 text-sm block mb-2">AÃ§Ä±klama</label>
                      <textarea
        ...
        {activeTab === 'users' && !loading && (
          <div className="glass-effect rounded-2xl p-6 fade-in">
            <h2 className="text-2xl font-bold text-white mb-4">KullanÄ±cÄ± YÃ¶netimi</h2>
            <div className="text-center py-12">
              <div className="text-6xl mb-4">ðŸ‘¥</div>
              <h3 className="text-xl font-bold text-white mb-2">YakÄ±nda</h3>
              <p className="text-slate-400">
                KullanÄ±cÄ± yÃ¶netimi Ã¶zellikleri yakÄ±nda eklenecek
              </p>
            </div>
          </div>
        )}
        ...
        <div className="mt-8 glass-effect rounded-2xl p-6 border border-yellow-500/30">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Bu admin panel demo amaÃ§lÄ±dÄ±r. FiyatlandÄ±rma gÃ¼ncellemeleri gerÃ§ek veritabanÄ±na kaydedilmez.
